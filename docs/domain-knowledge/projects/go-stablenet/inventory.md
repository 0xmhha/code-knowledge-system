...
| A3 | WBFT Validator Set & Epoch | 0 / 2 |
| A4 | System Contracts (Governance × 5) | 0 / 2 |
| A5 | Native Coin & Account Extra | 0 / 2 |
| A6 | Fee Delegation & Anzeon Gas | 0 / 2 |
| A7 | Hardfork & Chain Config | 0 / 1 |
| A8 | Genesis & Bootstrap | 0 / 3 |
...
| A3.timing.wbft_config_defaults | A3 | B7 | WBFT timing and config defaults: RequestTimeout, BlockPeriod, EpochLength | needs_verification | P1 |
...
| A5.native_coin.issuance_burn_flow | A5 | B3 | Native coin issuance and burn via NativeCoinManager precompile | needs_verification | P1 |
| A6.anzeon_gas.tip_override | A6 | B3 | Anzeon authorized-account gas tip override | needs_verification | P1 |
